  ...
  handleCommand(inputElement) {
    ...
    switch (cmd) {
      ...
      case "exit-game":
        ...
        break;
      case "exit":
        this.printToOutput(outputElement, "Redirecting to homepage...", "info");
...
<span style="color: #00ffff;">Project-Based Experience</span>
${this.wrapWithColor(
  "As a passionate student, my primary experience lies in building complex academic and personal projects.",
  "#ffffff"
)}

• ${this.wrapWithColor("Machine Learning", "#ffa07a")} - ${this.wrapWithColor(
      "Built predictive models and NLP pipelines using Scikit-learn, XGBoost, and LLaMA 3.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Full Stack Development", "#ffa07a")} - ${this.wrapWithColor(
      "Developed web applications using React, Node.js, Express, and MongoDB.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Core Coding & Systems", "#ffa07a")} - ${this.wrapWithColor(
      "Built data-structure-driven systems and OOP applications in C++, Java, and C#.",
      "#ffffff"
    )}

${this.wrapWithColor(
  "Type 'projects' to view my complete portfolio of work!",
  "#98fb98"
)}`;
  ...
  showEducation(outputElement = this.output) {
    const education =
      ...
      "\n" +
      this.wrapWithColor("│", "#ff8c00") +
      this.wrapWithColor("  BS Software Engineering — Bahria University         ", "#ffffff") +
      this.wrapWithColor("│", "#ff8c00") +
      "\n" +
      this.wrapWithColor("└─────────────────────────────────────────────────────┘", "#ff8c00") +
      "\n\n" +
      this.wrapWithColor("  📅 Expected:  ", "#ff8c00") + this.wrapWithColor("2027\n", "#ffffff") +
      this.wrapWithColor("  📍 Location:  ", "#ff8c00") + this.wrapWithColor("Islamabad, Pakistan\n", "#ffffff") +
      "\n" +
      this.wrapWithColor("╭─────────────────────────────────────────────────────╮", "#ff8c00") +
      "\n" +
      this.wrapWithColor("│", "#ff8c00") +
...
• ${this.wrapWithColor("Visual Studio", "#ffffff")}`;
  ...
  showContact(outputElement = this.output) {
    const contact =
      `<span style="color: #ff8c00; font-weight: bold;">📫 Contact Information</span>` +
      "\n\n" +
      this.wrapWithColor("┌──────────────────────────────────────────┐", "#ff8c00") +
      "\n" +
      this.wrapWithColor("│", "#ff8c00") +
      ...
      this.wrapWithColor("└──────────────────────────────────────────┘", "#ff8c00") +
      "\n\n" +
      this.wrapWithColor("  ✉  Email:    ", "#ff8c00") +
      '<a href="mailto:haiderjeh@gmail.com" style="color:#ffffff;text-decoration:none;">haiderjeh@gmail.com</a>' +
      "\n" +
      this.wrapWithColor("  ⚡  GitHub:   ", "#ff8c00") +
      '<a href="https://github.com/Shadowx69" target="_blank" style="color:#ffffff;text-decoration:none;">github.com/Shadowx69</a>' +
      "\n" +
      this.wrapWithColor("  💼  LinkedIn: ", "#ff8c00") +
      '<a href="https://linkedin.com/in/haider606" target="_blank" style="color:#ffffff;text-decoration:none;">linkedin.com/in/haider606</a>' +
      "\n\n" +
      this.wrapWithColor("╭──────────────────────────────────────────╮", "#ff8c00") +
      "\n" +
      this.wrapWithColor("│", "#ff8c00") +
    ...
    this.projects = [
      {
        ...
        description: "Built a text generation and fine-tuning pipeline using LLaMA 3 to auto-generate role-specific interview questions from intern profiles and job descriptions across 9 engineering domains.",
        technologies: ["Python", "LLaMA 3", "Prompt Engineering"],
        repo: "https://github.com/Shadowx69/interview-question-generator",
      },
      {
        title: "Intern Feedback Sentiment Analysis",
        description: "Performed NLP-based sentiment classification on 520+ feedback entries; compared traditional ML and transformer models for insights.",
        technologies: ["Python", "Transformers", "NLP"],
        repo: "https://github.com/Shadowx69/intern-feedback-analyzer",
      },
      {
        title: "Intern Performance Prediction",
        description: "Built regression models on 110+ records using attendance, task completion time, and feedback data; improved prediction accuracy with XGBoost.",
        technologies: ["Python", "Scikit-learn", "XGBoost"],
        repo: "https://github.com/Shadowx69/INTERN-PERFORMANCE-ML",
      },
      {
        title: "Wonderland Toy Store E-Commerce",
        description: "Developed full-stack application with admin panel and inventory system; implemented REST APIs and 3D model integration.",
        technologies: ["React", "Node.js", "Three.js"],
        repo: "https://github.com/Shadowx69/Wonderland-Toystore",
      },
      {
        title: "Dynamic Blog Platform CMS",
        description: "Built content management system with CRUD operations and responsive UI.",
        technologies: ["Node.js", "MongoDB", "Express"],
        repo: "https://github.com/Shadowx69/Blog-Site",
      },
      {
        title: "Event Management System",
        description: "Developed QR-based check-in system with real-time database validation.",
        technologies: ["C#", "SQL Server", "REST APIs"],
        repo: "https://github.com/Shadowx69/Event-Flow-Pro",
      },
      {
        title: "KeebX Interactive Product Page",
        description: "Implemented scroll-based animations with 120+ frame rendering and interactive UI effects.",
        technologies: ["Next.js", "TypeScript", "Framer Motion"],
        repo: "https://github.com/Shadowx69/KeebX-scrollytelling",
      },
      {
        title: "Train Route Management System",
        description: "Designed system using doubly linked lists for efficient route traversal and storage.",
        technologies: ["C++", "SQL Server"],
        repo: "https://github.com/Shadowx69/Train-Management-system-GUI-MySQL-c-",
      },
      {
        title: "ATM Simulation System",
        description: "Simulated banking operations using object-oriented design principles.",
        technologies: ["Java", "OOP"],
        repo: "https://github.com/Shadowx69/ATM",
      },
      {
        title: "Adventures of Eldoria",
        description: "Developed multi-stage turn-based strategy game applying inheritance and polymorphism.",
        technologies: ["C++"],
        repo: "https://github.com/Shadowx69/Adventures-of-Eldoria",
      },
    ];
  }
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Downloading PDF resume...", "info");
    
    setTimeout(() => {
      window.open('print/RECENTROX.pdf', '_blank');
      this.printToOutput(
        outputElement,
    ...
    const sketch = (p) => {
      ...
      p.keyPressed = () => {
        if (p.keyCode === 80) {
          ...
          return true; // Allow P key for typing if game is over
        }
  ...
  // (linkedin-cover command removed)
  _removed_generateLinkedInCover() {
    ...
    terminalTitle.textContent = "haider@mirza: ~/interactive-resume";
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝ ╚══════╝╚═╝  ╚═╝`;
    ...
    role.textContent = "Software Engineering Student • Full Stack ML Enthusiast";
    ...
    url.textContent = "haider-portfolio.vercel.app";
